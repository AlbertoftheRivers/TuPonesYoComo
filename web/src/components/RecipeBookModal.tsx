          ...
          >
            ...
            {!selectedCategory ? (
              ...
              <div className="space-y-3">
                {filtered.length === 0 ? (
                  <p className="text-muted-foreground text-center py-8">No recipes in this category yet.</p>
                ) : (
                  filtered.map((recipe) => (
                    <motion.button
                      key={recipe.id}
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">{recipe.cuisine} · {recipe.time}</p>
                        </div>
                      </div>
                    </motion.button>
                  ))
